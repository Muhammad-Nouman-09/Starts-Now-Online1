        ...
        <div className="lg:col-span-5 space-y-12">
          ...
          <div className="space-y-8">
            <div className="flex items-start gap-5">
              ...
              <div>
                <h4 className="text-[10px] font-bold text-zinc-300 uppercase tracking-widest mb-1 font-mono">Channel 01: Email</h4>
            ...
            <div className="flex items-start gap-5">
              ...
              <div>
                <h4 className="text-[10px] font-bold text-zinc-300 uppercase tracking-widest mb-1 font-mono">HQ: Decentralized</h4>
            ...
            <div className="flex items-start gap-5">
              ...
              <div>
                <h4 className="text-[10px] font-bold text-zinc-300 uppercase tracking-widest mb-1 font-mono">Global Relay</h4>
          ...
          <div className="bg-zinc-900/20 border border-zinc-800 rounded-[40px] p-8 md:p-12 shadow-2xl">
            {status === "sent" ? (
              ...
              >
                ...
                <p className="text-zinc-300 max-w-xs mx-auto">Your intelligence request has been broadcast to our operations team.</p>
                <button
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-[10px] font-bold text-zinc-300 uppercase tracking-widest pl-2">Identifier</label>
                    <input
                      type="text"
                      required
                      value={formData.name}
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-bold text-zinc-300 uppercase tracking-widest pl-2">Relay Address</label>
                    <input
                      type="email"
                      required
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-bold text-zinc-300 uppercase tracking-widest pl-2">Sector</label>
                  <select
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-bold text-zinc-300 uppercase tracking-widest pl-2">Transmission Data</label>
                  <textarea
                    rows={6}
                    required
