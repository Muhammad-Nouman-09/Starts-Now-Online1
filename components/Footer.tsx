...
export default function Footer() {
  return (
   <footer className="w-full border-t border-zinc-800/60 bg-[#0F1113]">
  <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 px-6 md:px-8 py-16 max-w-7xl mx-auto w-full">
    ...
    <div className="col-span-2">
      ...
      <div className="flex gap-4">
        <a href="#" aria-label="Visit our website" className="text-zinc-300 hover:text-emerald-400">
          <Globe className="w-5 h-5" />
        </a>
        <a href="#" aria-label="Share on social media" className="text-zinc-300 hover:text-emerald-400">
        ...
        <div className="max-w-7xl mx-auto w-full px-6 md:px-8 py-8 border-t border-zinc-800/60 text-center">
